...
export const GameConfig = {
  ...
  map: {
    ...
    originLatitude: 40.76, // Top-left corner (north-west) - ZOOMED IN
    originLongitude: -74.02, // Top-left corner (north-west) - ZOOMED IN
    boundaryLatitude: 40.73, // Bottom-right corner (south-east) - ZOOMED IN
    boundaryLongitude: -73.97, // Bottom-right corner (south-east) - ZOOMED IN

    // Default center position (for initialization)
    defaultCenter: { lat: 40.745, lng: -73.995 }, // New York City - centered better for zoom
    defaultZoom: 0, // Increased zoom level
